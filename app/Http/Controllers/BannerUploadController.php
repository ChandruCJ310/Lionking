...
class BannerUploadController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.upload_banners',compact('banner10000','banner5000','banner1000','banners','adimage','adimage2','image1','image2','image3')); // Ensure this matches your Blade file path
    }
...
public function deleteAdImage($id, $ad_type)
{
    ...
    return back()->with('success', 'Ad image deleted successfully!');
}

...
// Route::get('/search-members', [RoleController::class, 'searchMembers'])->name('search.members');
...
Route::get('/admin/add-members', [MemberController::class, 'create'])->name('members.add');
